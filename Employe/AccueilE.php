...
$data = $req->fetchAll();
  ...
  $req2=$con->prepare("SELECT COUNT(*) FROM `devise` ");
  $req2->execute();
  $data2 = $req2->fetchAll();
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            ...
            <h4>Heureux de vous retrouver !!!</h4>  
            </div>
          </form>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Employé</span>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            $okay = 12/$ok;
              ...
              foreach ($data as $elt) {
                echo '
                 <div class="col-xl-'. $okay.' col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">'.$elt['nom'].'</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">'.$elt['capital'].'</div>
                    </div>
                    <div class="col-auto">
